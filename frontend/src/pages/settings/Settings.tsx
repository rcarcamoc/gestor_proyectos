...
import { User, Lock, Palette, Save, AlertCircle, CheckCircle2 } from "lucide-react";
            ...
            {activeTab === "profile" && (
              <div className="space-y-6 animate-fade-in relative z-10">
                ...
                <div className="flex items-center gap-6 mb-8">
                  ...
                  <button className="px-4 py-2 bg-surface text-white border border-border/50 rounded-lg text-sm hover:bg-white/5 transition-colors">
                    Upload Avatar
                  </button>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input type="text" defaultValue="Admin User" className="w-full px-4 py-2.5 rounded-xl bg-surface/50 border border-border/50 focus:bg-surface focus:border-primary focus:ring-1 focus:ring-primary outline-none text-white transition-all" />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-text-muted uppercase tracking-wider mb-2">Email Address</label>
                    <input type="email" defaultValue="admin@smarttrack.com" className="w-full px-4 py-2.5 rounded-xl bg-surface/50 border border-border/50 focus:bg-surface focus:border-primary focus:ring-1 focus:ring-primary outline-none text-white transition-all" />
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="space-y-6 animate-fade-in relative z-10">
                ...
                <div className="space-y-4 max-w-md">
                  <div>
                    ...
                    <input type="password" placeholder="••••••••" className="w-full px-4 py-2.5 rounded-xl bg-surface/50 border border-border/50 focus:bg-surface focus:border-primary focus:ring-1 focus:ring-primary outline-none text-white transition-all" />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-text-muted uppercase tracking-wider mb-2">New Password</label>
                    <input type="password" placeholder="Min 8 characters" className="w-full px-4 py-2.5 rounded-xl bg-surface/50 border border-border/50 focus:bg-surface focus:border-primary focus:ring-1 focus:ring-primary outline-none text-white transition-all" />
                  </div>
                  <div>
            ...
            {activeTab === "appearance" && (
              <div className="space-y-6 animate-fade-in relative z-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg">
                  <div className="cursor-pointer border-2 border-primary bg-primary/10 rounded-xl p-4 flex items-center justify-between">
                    <div>
                      <h4 className="text-white font-medium">Dark Glassmorphism</h4>
                      <p className="text-xs text-text-muted mt-1">Current sleek design</p>
                    </div>
                    <div className="w-4 h-4 rounded-full bg-primary ring-2 ring-offset-2 ring-offset-background ring-primary" />
                  </div>
                  <div className="cursor-not-allowed opacity-50 border-2 border-border/50 bg-surface/50 rounded-xl p-4 flex items-center justify-between">
                    <div>
